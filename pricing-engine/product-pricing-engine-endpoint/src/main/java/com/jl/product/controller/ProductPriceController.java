...
public class ProductPriceController {
	...
	public ResponseEntity<List<ProductVO>> priceReducdedProducts(@PathVariable("labelType") PriceLableType labelType,@PathVariable("sortOrder") ProductSortBy sortBy) {
